...
## OVERVIEW
AUDEBase — 企业应用开发平台。微内核 + 插件热插拔架构，对标 Odoo、NocoBase、云表。当前早期阶段，零源代码，仅有配置/文档/代理基础设施。
...
├── docs/
│   └── architecture.md # 431 行 — 架构文档（企业应用平台）
...
| 架构文档 | `docs/architecture.md` | 架构文档（企业应用平台，431行）|
